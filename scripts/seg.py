            ...
            def ui(self, *args, **kwargs):
                with gr.Accordion(open=False, label=self.title()):
                    ...
                    self.infotext_fields = (
                        (
                            enabled,
                            lambda p: gr.Checkbox.update(value="seg_enabled" in p),
                        ),
                        (scale, "seg_scale"),
                        ...
                        (
                            ...
                            lambda p: gr.Dropdown.update(
                                value=p.get("seg_rescale_mode", "full")
                            ),
                        ),
                        (blur_sigma, "seg_blur_sigma"),
                        (
                            hr_override,
                            lambda p: gr.Checkbox.update(value="seg_hr_override" in p),
                        ),
                        (hr_cfg, "seg_hr_cfg"),
                        ...
                        (
                            hr_rescale_mode,
                            lambda p: gr.Dropdown.update(
                                value=p.get("seg_hr_rescale_mode", "full")
                            ),
                        ),
                        ...
                        (
                            block,
                            lambda p: gr.Dropdown.update(
                                value=p.get("seg_block", "middle")
                            ),
                        ),
                        (block_id, "seg_block_id"),
                        (
                            block_list,
                            lambda p: gr.Text.update(value=p.get("seg_block_list", "")),
                        ),
